...
local TriggerDelay = 0.05 -- 50ms por defecto
local UltimoDisparo = 0
local Disparando = false 

-- === CREACIÓN DE LA INTERFAZ NATIVA (SEBAS MX) ===
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "SebasMX_SafeTrigger"
...
MiniIcon.Visible = false -- Oculto al inicio
MiniIcon.Active = true
MiniIcon.Draggable = true -- También puedes mover el círculo por la pantalla
MiniIcon.Image = "rbxassetid://10612440939" -- ID del icono de una pistola/mira limpia de Roblox
MiniIcon.ImageColor3 = Color3.fromRGB(0, 160, 255)
MiniIcon.Parent = ScreenGui

-- Redondear el botón flotante en un círculo perfecto
local UICorner = Instance.new("UICorner")
UICorner.CornerRadius = UDim.new(1, 0)
UICorner.Parent = MiniIcon

-- Añadir contorno estético al círculo
local UIStroke = Instance.new("UIStroke")
UIStroke.Color = Color3.fromRGB(0, 160, 255)
UIStroke.Thickness = 2
UIStroke.Parent = MiniIcon

-- Marca de agua pequeña sobre el círculo flotante
...
MiniIcon.MouseButton1Click:Connect(function()
    ...
    MainFrame.Visible = true
    -- Mantiene el menú grande cerca de donde soltaste el círculo para tu comodidad
...
-- Bucle asíncrono optimizado contra Anti-Cheats (Error 267)
task.spawn(function()
    while true do
        task.wait(0.02)
